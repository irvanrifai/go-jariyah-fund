...
class WbsNewReplySender extends Mailable
{
    ...
    {
        return $this->subject('Laporan Anda '.$this->welcome['reference_number'].' Telah Diproses - Deputi Bidang Kewirausahaan')->markdown('emails.wbs-new-feedback-sender', [
