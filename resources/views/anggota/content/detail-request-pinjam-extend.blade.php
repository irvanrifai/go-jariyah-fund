                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    ...
                                    <div class="card" style="height: 14rem; max-width: 20rem;">
                                        <div class="card-body">
                                            <div class="bg-image hover-overlay ripple pb-2" data-mdb-ripple-color="light">
                                                <img id="output" src="https://mdbootstrap.com/img/Photos/Others/placeholder.jpg" class="img-thumbnail" style="height: 9rem; width: auto;">
                                            </div>
                                            <div class="badge rounded-pill bg-info">
                                                <label class="form-label text-white m-1" for="bukti_cicil">Upload Foto<sup class="text-danger">*</sup></label>
                                                <input type="file" class="form-control d-none" name="bukti_cicil" id="bukti_cicil" accept="image/*" onchange="loadFile(event)" value="{{ old('bukti_cicil') }}" required>
                                            </div>
                                        </div>
                                    </div>
