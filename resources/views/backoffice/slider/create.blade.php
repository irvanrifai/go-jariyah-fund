...
@section('title', 'Tambahkan Slider')

@section('content_header_title','Tambahkan Slider')
@section('content_header_prev_link','/backoffice/')
@section('content_header_prev_text','Dashboard')

@section('content')
    <form class="card" action="{{ route('backoffice.slider.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="card-header d-flex align-items-center">
            <h3 class="card-title">Slider: Tambah Baru</h3>
        </div>
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="input-title" placeholder="Judul"  required>
                    @error('title')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" id="input-desc" placeholder="Deskripsi" rows="4"></textarea>
                </div>
            </div>
            <div class="form-group row">
                <label for="input-title" class="col-sm-2 col-form-label">Link</label>
                <div class="col-sm-10">
                    <input type="text" name="link" class="form-control @error('title') is-invalid @enderror" id="input-title" placeholder="URL"  required>
                </div>
            </div>
            <div class="form-group row" id="form-image">
                ...
                <div class="col-sm-4">
                    <div class="input-group">
                        ...
                        <input id="thumbnail" type="text" name="image" class="form-control @error('image') is-invalid @enderror" readonly>
                    </div>
                    @error('image')
                    <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
                    <img id="holder" style="margin-top:15px;max-height:100px;">
                    Ukuran gambar yang disarankan: 683 x 384 px <br>
                    <span class="input-group-btn">
