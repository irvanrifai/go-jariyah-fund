...
@section('title', 'Sunting Halaman')

@section('content_header_title','Sunting Halaman')
...
@section('content')
    <form class="main-form" action="{{ route('backoffice.pages.update',$page->id) }}" method="POST"
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <input name="title" placeholder="Judul Halaman Anda" type="text" class="form-control"
                                   id="titleArticle"
                                   aria-describedby="helperTitle" value="{{$page->title}}"><br>
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input name="slug" type="text" class="form-control" id="slugURL"
                                       ...
                                       placeholder="URL halaman akan digenerate judul halaman." value="{{$page->slug}}"
                                       readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <textarea id="masterContent" name="main_content">{!! $page->content !!}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-3">
                <div class="form-group">
                    ...
                    <select class="form-control select2" id="mainStatus" name="status">
                        <option value="public" {{ $page->status==="public" ? 'selected' : '' }}>Publik</option>
                        <option value="private" {{ $page->status==="private" ? 'selected' : '' }}>Pribadi</option>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                       <span class="input-group-btn">
                        ...
                        <input id="thumbnail" class="form-control" type="text" value="{{$page->featured_image}}"
                ...
                <div class="form-group">
                    ...
                    <div class="collapse" id="deleteItem">
                        <button data-id="{{$page->id}}" type="button" class="btn btn-danger btn-sm btn-block"
    ...
    <form id="delete-form" action="{{route('backoffice.pages.destroy',$page->id)}}" method="POST"
          style="display: none;">
        @method('DELETE')
...
@section('adminlte_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            let route_prefix = '/backoffice/file-manager';
            $('#lfm').filemanager('image', {prefix: route_prefix});
            $('.uploader2').filemanager('image', {prefix: route_prefix});
