...
@section('title', 'Tambahkan Gambar')

@section('content_header_title','Tambahkan Gambar')
@section('content_header_prev_link','/backoffice/')
@section('content_header_prev_text','Dashboard')

@section('content')
    <form class="card" action="{{ route('backoffice.gallery.store') }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="card-header d-flex align-items-center">
            <h3 class="card-title">Gallery: Tambah Baru</h3>
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="input-title" placeholder="Judul" value="{{ $gallery->title ?? old('title') }}" required>
                    @error('title')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" id="input-desc" rows="4" placeholder="Deskripsi">{!! $gallery->desc ?? old('desc') !!}</textarea>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <medium class="text-muted">Ukuran gambar yang disarankan: 800 x 533 px</medium> <br>
                <span class="input-group-btn">
