    ...
    <div class="row">
                            ...
                            <tr id="row-num-{{ $li['id'] }}">
                                ...
                                <td>
                                    <a target="_blank" class="btn btn-link btn-sm text-info"
                                       href="/topik/{{ $li['slug'] }}/?preview=1" style="display: none"><i
                                            class="fas fa-eye"></i>&nbsp;
                                        Lihat</a> &nbsp;
                                    <a class="btn btn-link btn-sm text-primary"
                                       href="/backoffice/categories/{{ $li['id'] }}/edit"><i
        ...
        <div class="col-5">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="main-form" action="{{ route('backoffice.categories.update',$category->id) }}"
                          method="POST"
                        ...
                        <div class="form-group">
                            <input name="title" placeholder="Judul Kategori" type="text" class="form-control"
                                   id="titleCategory"
                                   aria-describedby="helperTitle" value="{!! $category->title !!}">
                        </div>
                        <div class="form-group">
                            <label for="descriptionCategory">Deskripsi</label>
                            <textarea name="description" class="form-control" id="descriptionCategory" rows="2">{{ $category->description }}</textarea>
                        </div>
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary btn-block"><i
                                    class="fas fa-tag"></i>&nbsp;&nbsp;&nbsp;Ubah Kategori
                            </button>
