...
@section('title', 'Tambahkan Artikel')

@section('content_header_title','Tambahkan Sebuah Artikel')
...
@section('content')
    <form class="main-form" action="{{ route('backoffice.posts.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <input name="title" placeholder="Judul Artikel Anda" type="text" class="form-control" id="titleArticle"
                            ...
                            <div class="input-group input-group-sm mb-3">
                                ...
                                <input name="slug" type="text" class="form-control" id="slugURL" aria-describedby="slug-url-desc"
                                       placeholder="URL artikel akan digenerate judul artikel." readonly>
                            </div>
                        </div>
                        <div class="form-group">
