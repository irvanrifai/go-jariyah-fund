        ...
        const table = $('#myTable').DataTable({
            ...
            columns: [
               ...
               // {data:'project_slug', name:'project_slug'},
                {data:'project_target_abadi', name:'project_target_abadi',render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )},
                {data:'project_target_kolektif', name:'project_target_kolektif', render: $.fn.dataTable.render.number( '.', ',', 0, 'Rp ' )},
               //{data:'project_target_tabarru', name:'project_target_tabarru'},
                {
                data: 'action',
                name: 'action',
                orderable: false,
