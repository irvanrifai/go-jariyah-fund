...
@section('body')
<div class="content">
    <h4 style="margin-left:15px"> Data List Anggota</h4></br>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <thead class="thead-light">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($key->status == 0) {
                                        echo '<span class="badge badge-danger badge-pill">TIDAK AKTIF</span>';
                                    } elseif ($key->status == 1) {
                                        echo '<span class="badge badge-success badge-pill">AKTIF</span>';
                                    } elseif ($key->status == 2) {
                                        echo '<span class="badge badge-warning badge-pill">FREEZE</span>';
                                    } else {
                                        echo '<span class="badge badge-light badge-pill">PENDING</span>';
                                    } ?>
                                </td>
