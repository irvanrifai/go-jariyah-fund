...
@section('body')
<div class="content">
    <h4 style="margin-left:15px"> Data Cicilan</h4></br>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="card-header">
                    <table id="myTable1" class="table table-hover table-striped table-bordered table-bordered" style="margin-top:10px;width:100%;">
                        <thead class="thead-light">
                            ...
                            <tr>
                                <td>{{$key->duta_name}}</td>
                                <td>{{$key->desc_request}}</td>
                                <td>{{"Rp". number_format($key->nominal)}}</td>
                                <td>
                                    <?php
                                    if ($key->is_valid == 0) {
                                        echo '<span class="badge badge-danger badge-pill">Tidak Valid</span>';
                                    } else {
                                        echo '<span class="badge badge-success badge-pill">Valid</span>';
                                    } ?>
                                </td>
